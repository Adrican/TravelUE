 ...
 */                                 //meterImagenEnFirebase();
    ...
    private void startPosting() {
        ...
        if (mImageUri == null){
            String fotoEjemplo = "https://firebasestorage.googleapis.com/v0/b/travelue-1b5e6.appspot.com/o/Photos%2Frabanosubir.png?alt=media&token=79a40e32-73cb-4107-9741-8a51b20c475e";
